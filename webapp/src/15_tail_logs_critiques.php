...
$script_path = '/var/www/cmd/15_tail_logs_critiques.sh';

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax_run'])) {
    log_audit('Execute Script', 'Script: 15_tail_logs_critiques.php');
...
<head>
    <meta charset='UTF-8'>
    <title>Live Logs Tracking (Tail) - Critical Apps</title>
...
<body class='bg-light'>
    ...
    <div class='container py-4'>
        <div class='d-flex justify-content-between align-items-center mb-3 bg-white p-3 rounded shadow-sm border'>
            <h4 class='m-0 text-primary'>Live Logs Tracking (Tail) - Critical Apps</h4>
