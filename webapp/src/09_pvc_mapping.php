...
<head>
    <meta charset='UTF-8'>
    <title>Cartographie des volumes (PVC) et Pods associés</title>
...
<body class='bg-light'>
    <div class='container py-4'>
        ...
        <div class='card shadow-sm border-0'>
            <div class='card-header bg-dark text-white'><h5>Cartographie des volumes (PVC) et Pods associés</h5></div>
