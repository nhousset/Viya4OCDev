...
<head>
    <meta charset='UTF-8'>
    <title>Vérification des Certificats TLS (cert-manager)</title>
...
<body class='bg-light'>
    <div class='container py-4'>
        ...
        <div class='card shadow-sm border-0'>
            <div class='card-header bg-dark text-white'><h5>Vérification des Certificats TLS (cert-manager)</h5></div>
