...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax_run'])) {
    log_audit('Execute Script', 'Script: 14_gestion_pods.php');
...
<head>
    <meta charset='UTF-8'>
    <title>Interactive Pod Management (Search, Logs, Shell)</title>
...
<body class='bg-light'>
    ...
    <div class='container py-4'>
        <div class='d-flex justify-content-between align-items-center mb-3 bg-white p-3 rounded shadow-sm border'>
            <h4 class='m-0 text-primary'>Interactive Pod Management (Search, Logs, Shell)</h4>
