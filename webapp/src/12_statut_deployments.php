...
\ = '/var/www/config.env';
\ = file_exists(\) ? 'source '.\.' && ' : '';
\ = '/var/www/cmd/12_statut_deployments.sh';
...
<head>
    <meta charset='UTF-8'>
    <title>Statut des Déploiements (Microservices)</title>
...
<body class='bg-light'>
    <div class='container py-4'>
        ...
        <div class='card shadow-sm border-0'>
            <div class='card-header bg-dark text-white'><h5>Statut des Déploiements (Microservices)</h5></div>
