...
<body>
                    ...
                    <div class="col-12">
                        <div class="card shadow-sm border-0 bg-info bg-opacity-10">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div>
                                    <h5 class="text-info-emphasis mb-1"><i class="bi bi-table me-2"></i>Vues PersonnalisÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©es Web</h5>
                                    <p class="mb-0 text-muted small">Interfaces web natives optimisÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©es pour analyser les ressources.</p>
                                </div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body text-center py-4" id="connModalBody">
            ...
            <h5>VÃƒÂ©rification de la connexion au cluster...</h5>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        // Only run check on dashboard load
            ...
            try {
                ...
                if (data.status === 'config_missing') {
                    body.innerHTML = 
                        ...
                        <h5>Configuration IncomplÃƒÂ¨te</h5>
                        <p class="text-muted">L'URL du cluster n'est pas configurÃƒÂ©e pour ce profil.</p>
                    ;
                    footer.innerHTML = <a href="config_manager.php" class="btn btn-primary"><i class="bi bi-gear me-2"></i>Aller ÃƒÂ  la Configuration</a>;
                    ...
                    body.innerHTML = 
                        ...
                        <h5 class="text-danger">Token ExpirÃƒÂ© ou Manquant</h5>
                        <p class="text-muted small mb-2">Impossible de se connecter ÃƒÂ  <strong>+data.server+</strong></p>
                        +linkHtml+
                    ...
                    body.innerHTML = 
                        ...
                        <h5 class="text-success">Connexion RÃƒÂ©ussie</h5>
                        <p class="text-muted small">ConnectÃƒÂ© au cluster avec succÃƒÂ¨s.</p>
                    ;
                    footer.style.display = 'none';
                    setTimeout(() => { connModal.hide(); }, 1500);
                }
            } catch (err) {
                body.innerHTML = <i class="bi bi-x-octagon text-danger mb-3" style="font-size: 3rem;"></i><h5>Erreur SystÃƒÂ¨me</h5><p class="text-danger">+err.message+</p>;
        ...
        window.saveNewToken = async function() {
            ...
            // Retry connection
            document.getElementById('connModalBody').innerHTML = <div class="spinner-border text-primary mb-3" style="width: 3rem; height: 3rem;"></div><h5>VÃƒÂ©rification de la connexion...</h5>;
...
</html>SESSION['cluster_connected'][`$active_profile])): ?>
