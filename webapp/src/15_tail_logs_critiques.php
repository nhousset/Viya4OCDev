...
<head>
    <meta charset='UTF-8'>
    <title>Suivi des logs en direct (Tail) - Apps Critiques</title>
...
<body class='bg-light'>
    <div class='container py-4'>
        ...
        <div class='card shadow-sm border-0'>
            <div class='card-header bg-dark text-white'><h5>Suivi des logs en direct (Tail) - Apps Critiques</h5></div>
