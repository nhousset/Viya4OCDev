...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax_run'])) {
    log_audit('Execute Script', 'Script: 12_statut_deployments.php');
...
<head>
    <meta charset='UTF-8'>
    <title>Deployments, StatefulSets & DaemonSets Status</title>
...
<body class='bg-light'>
    ...
    <div class='container py-4'>
        <div class='d-flex justify-content-between align-items-center mb-3 bg-white p-3 rounded shadow-sm border'>
            <h4 class='m-0 text-primary'>Deployments, StatefulSets & DaemonSets Status</h4>
