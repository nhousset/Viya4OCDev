...
\ = '/var/www/config.env';
\ = file_exists(\) ? 'source '.\.' && ' : '';
\ = '/var/www/cmd/98_stop_start_viya4.sh';
...
<head>
    <meta charset='UTF-8'>
    <title>Démarrer / Arrêter l'environnement Viya 4</title>
...
<body class='bg-light'>
    <div class='container py-4'>
        ...
        <div class='card shadow-sm border-0'>
            <div class='card-header bg-dark text-white'><h5>Démarrer / Arrêter l'environnement Viya 4</h5></div>
