...
<head>
    <meta charset='UTF-8'>
    <title>Audit de santé complet (Noeuds, Pods, Réseau, Limites)</title>
...
<body class='bg-light'>
    <div class='container py-4'>
        ...
        <div class='card shadow-sm border-0'>
            <div class='card-header bg-dark text-white'><h5>Audit de santé complet (Noeuds, Pods, Réseau, Limites)</h5></div>
