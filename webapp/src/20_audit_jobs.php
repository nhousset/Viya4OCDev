...
$script_path = '/var/www/cmd/20_audit_jobs.sh';

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax_run'])) {
    log_audit('Execute Script', 'Script: 20_audit_jobs.php');
...
<head>
    <meta charset='UTF-8'>
    <title>Jobs Audit & Management (K8s & Viya Execution)</title>
...
<body class='bg-light'>
    ...
    <div class='container py-4'>
        <div class='d-flex justify-content-between align-items-center mb-3 bg-white p-3 rounded shadow-sm border'>
            <h4 class='m-0 text-primary'>Jobs Audit & Management (K8s & Viya Execution)</h4>
