...
\ = '/var/www/config.env';
\ = file_exists(\) ? 'source '.\.' && ' : '';
\ = '/var/www/cmd/08_limites_quotas.sh';
...
<head>
    <meta charset='UTF-8'>
    <title>Audit des Limites et Quotas (CPU/RAM)</title>
...
<body class='bg-light'>
    <div class='container py-4'>
        ...
        <div class='card shadow-sm border-0'>
            <div class='card-header bg-dark text-white'><h5>Audit des Limites et Quotas (CPU/RAM)</h5></div>
