...
$script_path = '/var/www/cmd/10_top_pods.sh';

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax_run'])) {
    log_audit('Execute Script', 'Script: 10_top_pods.php');
...
<head>
    <meta charset='UTF-8'>
    <title>Top 10 Pods (CPU/RAM Consumption)</title>
...
<body class='bg-light'>
    ...
    <div class='container py-4'>
        <div class='d-flex justify-content-between align-items-center mb-3 bg-white p-3 rounded shadow-sm border'>
            <h4 class='m-0 text-primary'>Top 10 Pods (CPU/RAM Consumption)</h4>
