...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax_run'])) {
    log_audit('Execute Script', 'Script: 09_pvc_mapping.php');
...
<head>
    <meta charset='UTF-8'>
    <title>Volume Mapping (PVC) and Associated Pods</title>
...
<body class='bg-light'>
    ...
    <div class='container py-4'>
        <div class='d-flex justify-content-between align-items-center mb-3 bg-white p-3 rounded shadow-sm border'>
            <h4 class='m-0 text-primary'>Volume Mapping (PVC) and Associated Pods</h4>
