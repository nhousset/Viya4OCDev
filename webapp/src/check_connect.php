...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax_run'])) {
    log_audit('Execute Script', 'Script: check_connect.php');
...
<head>
    <meta charset='UTF-8'>
    <title>Verify SAS Viya CLI Connection</title>
...
<body class='bg-light'>
    ...
    <div class='container py-4'>
        <div class='d-flex justify-content-between align-items-center mb-3 bg-white p-3 rounded shadow-sm border'>
            <h4 class='m-0 text-primary'>Verify SAS Viya CLI Connection</h4>
