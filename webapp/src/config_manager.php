...
$fields_def = [
    ...
    'SERVER_URL' => ['label' => "OpenShift Cluster URL", 'placeholder' => 'https://api.cluster.com:6443', 'type' => 'text'],
    'TOKEN_URL' => ['label' => "OpenShift Token URL", 'placeholder' => 'Lien de login ou \'skip\'', 'type' => 'text'],
    'DEFAULT_NAMESPACE' => ['label' => "SAS Viya Namespace", 'placeholder' => 'sas-viya', 'type' => 'text'],
    'SAS_VIYA_URL' => ['label' => "SAS Viya API URL", 'placeholder' => 'https://viya.monsite.com', 'type' => 'text'],
    'AUDIT_OUT_DIR' => ['label' => "Audit Output Directory", 'placeholder' => '/var/www/rapports_audit', 'type' => 'text'],
